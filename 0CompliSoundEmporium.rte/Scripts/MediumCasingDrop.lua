...
function Create(self)
	...
	self.CompliSoundCasingDropTerrainSounds.Hit.Concrete = CreateSoundContainer("CompliSound Casing Drop Medium Hit Concrete", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.Dirt = CreateSoundContainer("CompliSound Casing Drop Medium Hit Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.Sand = CreateSoundContainer("CompliSound Casing Drop Medium Hit Sand", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.SolidMetal = CreateSoundContainer("CompliSound Casing Drop Medium Hit SolidMetal", "0CompliSoundEmporium.rte");

	self.CompliSoundCasingDropTerrainSounds.Roll = {};
	self.CompliSoundCasingDropTerrainSounds.Roll.Concrete = CreateSoundContainer("CompliSound Casing Drop Medium Roll Concrete", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Roll.Dirt = CreateSoundContainer("CompliSound Casing Drop Medium Roll Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Roll.Sand = CreateSoundContainer("CompliSound Casing Drop Medium Roll Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Roll.SolidMetal = CreateSoundContainer("CompliSound Casing Drop Medium Roll SolidMetal", "0CompliSoundEmporium.rte");
