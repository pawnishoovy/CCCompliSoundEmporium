...
function Create(self)
	...
	self.CompliSoundBulletTerrainSounds.Concrete = CreateSoundContainer("CompliSound Shotgun Bullet Impact Concrete", "0CompliSoundEmporium.rte");
	self.CompliSoundBulletTerrainSounds.Dirt = CreateSoundContainer("CompliSound Shotgun Bullet Impact Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundBulletTerrainSounds.Sand = CreateSoundContainer("CompliSound Shotgun Bullet Impact Sand", "0CompliSoundEmporium.rte");
