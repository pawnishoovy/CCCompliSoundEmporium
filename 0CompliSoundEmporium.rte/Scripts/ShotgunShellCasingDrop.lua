...
function Create(self)
	...
	self.CompliSoundCasingDropTerrainSounds.Hit.Concrete = CreateSoundContainer("CompliSound Casing Drop Shotgun Shell Hit Concrete", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.Dirt = CreateSoundContainer("CompliSound Casing Drop Shotgun Shell Hit Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.Sand = CreateSoundContainer("CompliSound Casing Drop Shotgun Shell Hit Sand", "0CompliSoundEmporium.rte");
	self.CompliSoundCasingDropTerrainSounds.Hit.SolidMetal = CreateSoundContainer("CompliSound Casing Drop Shotgun Shell Hit SolidMetal", "0CompliSoundEmporium.rte");
