...
function Create(self)
	...
	self.terrainSounds = {
	Impact = {[12] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Concrete", "0CompliSoundEmporium.rte"),
			[164] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Concrete", "0CompliSoundEmporium.rte"),
			[177] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Concrete", "0CompliSoundEmporium.rte"),
			[9] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Dirt", "0CompliSoundEmporium.rte"),
			[10] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Dirt", "0CompliSoundEmporium.rte"),
			[11] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Dirt", "0CompliSoundEmporium.rte"),
			[128] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Dirt", "0CompliSoundEmporium.rte"),
			[6] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Sand", "0CompliSoundEmporium.rte"),
			[8] = CreateSoundContainer("CompliSound Shotgun Bullet Impact Sand", "0CompliSoundEmporium.rte"),
			[178] = CreateSoundContainer("CompliSound Shotgun Bullet Impact SolidMetal", "0CompliSoundEmporium.rte"),
			[179] = CreateSoundContainer("CompliSound Shotgun Bullet Impact SolidMetal", "0CompliSoundEmporium.rte"),
			[180] = CreateSoundContainer("CompliSound Shotgun Bullet Impact SolidMetal", "0CompliSoundEmporium.rte"),
			[181] = CreateSoundContainer("CompliSound Shotgun Bullet Impact SolidMetal", "0CompliSoundEmporium.rte"),
			[182] = CreateSoundContainer("CompliSound Shotgun Bullet Impact SolidMetal", "0CompliSoundEmporium.rte")}}
