...
function Create(self)
	...
	self.CompliSoundBulletTerrainSounds.Concrete = CreateSoundContainer("CompliSound Heavy Bullet Impact Concrete", "0CompliSoundEmporium.rte");
	self.CompliSoundBulletTerrainSounds.Dirt = CreateSoundContainer("CompliSound Heavy Bullet Impact Dirt", "0CompliSoundEmporium.rte");
	self.CompliSoundBulletTerrainSounds.Sand = CreateSoundContainer("CompliSound Heavy Bullet Impact Sand", "0CompliSoundEmporium.rte");
	self.CompliSoundBulletTerrainSounds.SolidMetal = CreateSoundContainer("CompliSound Heavy Bullet Impact SolidMetal", "0CompliSoundEmporium.rte");
